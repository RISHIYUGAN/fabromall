  ...
  const confirmcode=(e)=>{
    ...
    .then((res)=>{
      ...
      if(res.data.attempts){
        if(res.data.status===200){
          document.getElementById("verify-error").innerHTML="Signup Successful"
        }
        else{
          
          document.getElementById("verify-error").innerHTML="OTP is Incorrect! Please verify and try again"
    ...
    setTimeout(()=>{
      ...
      document.getElementById("verify-error").style.padding="0px 0px"
        ...
        document.getElementById("verify-error").innerHTML="Too many attempts! Please verify your mail and try again"
        document.getElementById("verify-error").style.padding="0px 5px"
          document.getElementById("verify-error").style.width="100%"
      ...
      <div className="Login-Container">
        <div className="login-wrapper">
          <div className="side-image">
            <div style={{marginTop:"10px",marginLeft:"20px",fontSize:"18px"}}><text style={{color:"#FF4545"}}>fabro</text><text style={{color:"#374FCD"}}>Mall</text></div>
        ...
        {!signup ? (
          ...
          <div className="sidebox">
            ...
            <div className="confirm-signup">
              <p className="verify-error" id="verify-error">Too many attempts verify mail and signup again !</p>
          <h2 className="verify-header">
            Verify Code
          </h2>
          <div className="verify-content">
              A confirmation code was sent to your mail. please check the 5 digit code sent to your mail and enter below
          </div>
            <label>
              Enter Code:
            </label>
          ...
          <div className="verify-btn"><button>Verify</button></div>
          </form>
       </div>   
          :
          <div className="sidebox">
